sap.ui.require(
    [
        ...
        'capfullstack/test/integration/FirstJourney',
		'capfullstack/test/integration/pages/Interactions_HeaderList',
		'capfullstack/test/integration/pages/Interactions_HeaderObjectPage',
		'capfullstack/test/integration/pages/Interactions_ItemsObjectPage'
    ],
    function(JourneyRunner, opaJourney, Interactions_HeaderList, Interactions_HeaderObjectPage, Interactions_ItemsObjectPage) {
        ...
        var JourneyRunner = new JourneyRunner({
            ...
            launchUrl: sap.ui.require.toUrl('capfullstack') + '/index.html'
        });
